...
import DashboardComponent from "components/pages/user/dashboard";
...
import PostCard from "components/pages/user/dashboard/post_card";
// import AuthLayout from "../auth_layout";
// import AdForm from "./ad_form";

export default function Dashboard({ pageProps:  {user} }) {
