          ...
          media && multiple && (media?.length > 0 || Object.values(media).length > 0)
            ? (
                <>
                  ...
                  <Btn
                    content={<span className="flex items-center"><UIcons.UilPlus size={18} className="mr-1" /> Add image</span>}
                ...
                <>
                  {
                    media ? (
                      <div className="relative w-44 h-20 mr-3">
                        {
                          !media[0]?.size ? (
                            <UIcons.UilImage size={80} />
                          ) : (
                            <>
                              {/* Uploaded image */}
                      ...
                      <UIcons.UilImage size={90} className="mr-3" />
                    )
                  }
